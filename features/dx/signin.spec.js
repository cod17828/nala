  ...
  features: [
    {
      ...
      testId: '@MWPW-140197',
      path: '/solutionpartners/drafts/automation/regression/public-page',
      tags: '@dx-signin @regression @login',
    },
    {
      tcid: '2',
    ...
    },
    {
      ...
      testId: '@MWPW-140207',
      path: '/solutionpartners/drafts/automation/regression/public-page',
      newsPath: '/solutionpartners/drafts/automation/regression/partner-news',
      tags: '@dx-signin @regression @login',
    },
    {
      tcid: '6',
      ...
      testId: '@MWPW-140202',
      path: '/solutionpartners/drafts/automation/regression/protected-home',
      baseURL: 'https://www.stage.adobe.com/partners.html',
      tags: '@dx-signin @regression @login',
    },
    {
